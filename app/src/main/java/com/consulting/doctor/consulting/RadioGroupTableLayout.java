 ...
 * @see RadioButton
 */
public class RadioGroupTableLayout extends LinearLayout {
...
//        attributes.recycle();
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(RadioGroupTableLayout group, @IdRes int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            traverseTree(child);
            if (parent == RadioGroupTableLayout.this && child instanceof RadioButton) {
                int id = child.getId();
                // generates an id if it's missing
                if (id == View.NO_ID) {
                    id = View.generateViewId();
